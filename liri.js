/* Commands necessary for this assignment:

`my-tweets` - node liri.js my-tweets (show last 20 tweets and when created)

* `spotify-this-song` - node liri.js spotify-this-song '<song name here>' (show artist, song name, preview link, and album)/ If no song is provided then your program will default to "The Sign" by Ace of Base.

* `movie-this`- node liri.js movie-this '<movie name here>' ( show * Title of the movie.
   ...
   * Plot of the movie.
   * Actors in the movie.
) if nothing typed show Mr. Nobody/If you haven't watched "Mr. Nobody," then you should: http://www.imdb.com/title/tt0485947/
...
var keys = require('../School Assignment/keys');
